...
public class WidgetWeekProvider extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        if (pendingIntent == null) {
            Intent alarmIntent = new Intent(context, WidgetWeekService.class);
        ...
        alarmManager.setRepeating(AlarmManager.ELAPSED_REALTIME_WAKEUP,
                SystemClock.elapsedRealtime(), hours, pendingIntent);
    }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        switch (action) {
            case "com.geometricweather.receiver.REFRESH_WIDGET":
                // update
                Intent intentRefresh = new Intent(context, WidgetWeekService.class);
