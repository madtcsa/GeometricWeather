...
public class CreateWidgetClockDayCenterActivity extends Activity
    ...
    private void initWidget() {
        ...
        Switch showCardSwitch = (Switch) findViewById(R.id.activity_create_widget_clock_day_center_showCardSwitch);
        showCardSwitch.setOnCheckedChangeListener(new ShowCardSwitchCheckListener());

        Switch hideRefreshTimeSwitch = (Switch) findViewById(R.id.activity_create_widget_clock_day_center_hideRefreshTimeSwitch);
        hideRefreshTimeSwitch.setOnCheckedChangeListener(new HideRefreshTimeSwitchCheckListener());

        Switch blackTextSwitch = (Switch) findViewById(R.id.activity_create_widget_clock_day_center_blackTextSwitch);
