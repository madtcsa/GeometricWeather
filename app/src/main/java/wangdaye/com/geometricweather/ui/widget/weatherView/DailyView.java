...
public class DailyView extends View {
    ...
    public void setData(int[] maxiTemps, int[] miniTemps, int[] yesterdayTemps) {
        ...
        if (yesterdayTemps != null && yesterdayTemps[0] < yesterdayTemps[1]) {
            int temp = yesterdayTemps[0];
            yesterdayTemps[0] = yesterdayTemps[1];
            yesterdayTemps[1] = temp;
        }
        this.yesterdayTemps = yesterdayTemps;
