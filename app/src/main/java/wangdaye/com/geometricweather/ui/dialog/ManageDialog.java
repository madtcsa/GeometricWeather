...
import wangdaye.com.geometricweather.data.item.LocationItem;
...
public class ManageDialog extends DialogFragment
    ...
    public void onDestroy() {
        super.onDestroy();
        if (!selectedLocation) {
            ((MainActivity) getActivity()).showCircularSky();
        }
    }
    ...
    private void initData() {
        List<Location> locationList = LocationTable.readLocationList(
                getActivity(),
    ...
    public class LocationSwipeCallback extends ItemTouchHelper.SimpleCallback {
        ...
        public LocationSwipeCallback(int dragDirs, int swipeDirs) {
