    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.dialog_time_setter_done:
                ...
                if (today) {
                    editor.putString(getString(R.string.key_forecast_time_today), hourText + ":" + minuteText);
                } else {
                    editor.putString(getString(R.string.key_forecast_time_tomorrow), hourText + ":" + minuteText);
                }
                editor.apply();
